...
public class TwitterTweetJob extends QuartzJobBean {
        ...
        protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
                ...
                TwitterTweetEntity twitterTweet = postFacade.findTwitterTweet((UUID) dataMap.get("twitter-tweet-id"));
                // TODO handle uploading images
                TweetCreateResponseData tweetRes = twitterHelper.sendTwitterTweet(
