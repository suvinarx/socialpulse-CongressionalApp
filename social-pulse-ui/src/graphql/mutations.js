...
export const UPDATE_TWITTER_TWEET = gql`
  mutation UpdateTwitterTweet($updateTwitterTweetInput: UpdateTwitterTweetInput!) {
    updateTwitterTweet(updateTwitterTweetInput: $updateTwitterTweetInput) {
      id
      message
      media
      scheduledPublishTime
